...
# Embedded dataset (PASTE FULL 50-ITEM LIST FROM CELL 4 HERE)
data = [
    ...
    {"item": "wine", "carbon_footprint_kg_per_kg": 2.5, "category": "beverage", "sustainable_alternative": "local beer (short supply chain)"},
...
# calculate_impact Function (from Cell 8)
def calculate_impact(shopping_list):
    ...
    for item in shopping_list:
        ...
        if not match.empty:
            ...
            impacts[item] = footprint * 0.5  # 0.5kg assumption
...
# Streamlit App (from Cell 13, emoji removed for compatibility)
def main():
    st.title("Eco-Impact Labeler: Make Your Shopping Sustainable!")  # Emoji removed to avoid encoding issues
